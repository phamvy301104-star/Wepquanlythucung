...
export const serviceApi = {
  ...
  createServiceCategory: (data: any) => api.post('/service-categories', data),
  updateServiceCategory: (id: string, data: any) => api.put(`/service-categories/${id}`, data),
  deleteServiceCategory: (id: string) => api.delete(`/service-categories/${id}`),
