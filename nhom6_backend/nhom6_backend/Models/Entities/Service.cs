...
namespace nhom6_backend.Models.Entities
{
    ...
    public class Service : BaseEntity
    {
        ...
        /// <summary>
        /// Giá tối thiểu (nếu giá thay đổi theo độ dài tóc, etc.)
        /// </summary>
        [Column(TypeName = "decimal(18, 2)")]
        ...
        /// <summary>
        /// Thời gian buffer sau dịch vụ (phút) - để chuẩn bị cho khách tiếp theo
        /// </summary>
        ...
        /// <summary>
        /// Cảnh báo/Lưu ý cho khách
        /// </summary>
        [MaxLength(500)]
        public string? Warnings { get; set; }

        /// <summary>
        /// Dịch vụ đi kèm (Combo) - JSON array of service IDs
        /// </summary>
